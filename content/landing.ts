export const landing = {
  ...
  solution: {
    ...
    paragraphs: [
      "Chaque semaine, des dizaines de followers de Heiven me demandent où trouver un médecin fonctionnel dans leur région ou en visio, ou un praticien spécialisé sur leur problématique. Pendant des années, je leur ai répondu un par un - en message privé, en commentaire, ou en mettant les experts en story avec un lien vers leur site ou leur profil Doctolib.",
      "La demande est là.",
